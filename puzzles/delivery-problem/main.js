...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return $mobx; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return toJS; });
...
"use strict";
/* harmony import */ var _addEventListener__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(21);
...
/* harmony import */ var _canUseDOM__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
...
/* harmony import */ var dom_helpers_ownerDocument__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8);
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "body{font-family:\"Helvetica Neue\",Helvetica,Arial,sans-serif;font-size:14px;line-height:1.42857143;color:#333}.footer{margin:30px 0 0;border-top:1px solid #ccc;text-align:left}.footer>div{margin:20px auto;font-size:13px}.jumbotron{margin-bottom:30px;color:inherit;background-color:#eee}@media screen and (min-width: 768px){.jumbotron{padding-top:48px;padding-bottom:48px}.jumbotron h1{font-size:63px}.jumbotron p{margin-bottom:15px;font-size:21px;font-weight:200}}.isCorrect{background-color:#b1e3bc;transition:all 1s ease-in}.game{margin:50px 0 0 100px}.levelCompleted{color:#5cb85c !important}.container-0 .center{display:flex;justify-content:center}.container-0 .buttonsGroup{margin-top:50px}.container-0 .snowplow{height:60px}.container-0 #canvas{position:absolute;z-index:1;transform:translateY(6px) translateX(6px)}.container-0 .pointLegend{position:absolute}.container-0 .point{height:12px;width:12px;border-radius:50%;background-color:green;position:absolute;cursor:pointer}.container-0 .point:hover{background-color:#5cb85c}.container-0 .point.pointDisabled{background-color:#a94442;cursor:not-allowed;transition-property:background-color,cursor;transition-duration:.5s}.container-0 .point.pointDisabled:hover{background-color:#a94442}.container-0 .pointsContainer{position:relative;z-index:2}.container-1 .center{display:flex;justify-content:center}.container-1 .buttonsGroup{margin-top:50px}.container-1 .snowplow{height:60px}.container-1 #canvas{position:absolute;z-index:1;transform:translateY(6px) translateX(6px)}.container-1 .pointLegend{position:absolute}.container-1 .point{height:12px;width:12px;border-radius:50%;background-color:green;position:absolute;cursor:pointer}.container-1 .point:hover{background-color:#5cb85c}.container-1 .point.pointDisabled{background-color:#a94442;cursor:not-allowed;transition-property:background-color,cursor;transition-duration:.5s}.container-1 .point.pointDisabled:hover{background-color:#a94442}.container-1 .pointsContainer{position:relative;z-index:2}.container-2 .center{display:flex;justify-content:center}.container-2 .buttonsGroup{margin-top:50px}.container-2 .snowplow{height:60px}.container-2 #canvas{position:absolute;z-index:1;transform:translateY(6px) translateX(6px)}.container-2 .pointLegend{position:absolute}.container-2 .point{height:12px;width:12px;border-radius:50%;background-color:green;position:absolute;cursor:pointer}.container-2 .point:hover{background-color:#5cb85c}.container-2 .point.pointDisabled{background-color:#a94442;cursor:not-allowed;transition-property:background-color,cursor;transition-duration:.5s}.container-2 .point.pointDisabled:hover{background-color:#a94442}.container-2 .pointsContainer{position:relative;z-index:2}.container-3 .center{display:flex;justify-content:center}.container-3 .buttonsGroup{margin-top:50px}.container-3 .snowplow{height:60px}.container-3 #canvas{position:absolute;z-index:1;transform:translateY(6px) translateX(6px)}.container-3 .pointLegend{position:absolute}.container-3 .point{height:12px;width:12px;border-radius:50%;background-color:green;position:absolute;cursor:pointer}.container-3 .point:hover{background-color:#5cb85c}.container-3 .point.pointDisabled{background-color:#a94442;cursor:not-allowed;transition-property:background-color,cursor;transition-duration:.5s}.container-3 .point.pointDisabled:hover{background-color:#a94442}.container-3 .pointsContainer{position:relative;z-index:2}.container-4 .center{display:flex;justify-content:center}.container-4 .buttonsGroup{margin-top:50px}.container-4 .snowplow{height:60px}.container-4 #canvas{position:absolute;z-index:1;transform:translateY(6px) translateX(6px)}.container-4 .pointLegend{position:absolute}.container-4 .point{height:12px;width:12px;border-radius:50%;background-color:green;position:absolute;cursor:pointer}.container-4 .point:hover{background-color:#5cb85c}.container-4 .point.pointDisabled{background-color:#a94442;cursor:not-allowed;transition-property:background-color,cursor;transition-duration:.5s}.container-4 .point.pointDisabled:hover{background-color:#a94442}.container-4 .pointsContainer{position:relative;z-index:2}.container-0{position:relative;top:0px;display:flex;flex-direction:column;align-items:center}.container-1{position:relative;top:0px;display:flex;flex-direction:column;align-items:center}.container-2{position:relative;top:0px;display:flex;flex-direction:column;align-items:center}.container-3{position:relative;top:0px;display:flex;flex-direction:column;align-items:center}.container-4{position:relative;top:0px;display:flex;flex-direction:column;align-items:center}.customFluidContainer{padding:0}.jumbotron{text-align:center}", ""]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(26),r=__webpack_require__(50);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));
...
// EXTERNAL MODULE: ./src/next/clientOnly/DeliveryProblem/styles/index.scss
...
function observerBatching(reactionScheduler) {
    ...
    Object(mobx_esm["g" /* configure */])({ reactionScheduler: reactionScheduler });
}
...
function printDebugValue(v) {
    return Object(mobx_esm["i" /* getDependencyTree */])(v);
}
...
function useLocalObservable(initializer, annotations) {
    return Object(react["useState"])(function () { return Object(mobx_esm["n" /* observable */])(initializer(), annotations, { autoBind: true }); })[0];
}
...
function useAsObservableSource(current) {
    if (false)
        {}
    var _a = useAsObservableSource_read(Object(react["useState"])(function () { return Object(mobx_esm["n" /* observable */])(current, {}, { deep: false }); }), 1), res = _a[0];
...
function useLocalStore(initializer, current) {
    ...
    return Object(react["useState"])(function () { return Object(mobx_esm["n" /* observable */])(initializer(source), undefined, { autoBind: true }); })[0];
}
...
function makeObservableProp(target, propName) {
  ...
  function getAtom() {
    if (!this[atomHolderKey]) {
      setHiddenProp(this, atomHolderKey, Object(mobx_esm["h" /* createAtom */])("reactive " + propName));
    }
...
function createChainableTypeChecker(validator) {
  function checkType(isRequired, props, propName, componentName, location, propFullName) {
    ...
    return Object(mobx_esm["q" /* untracked */])(function () {
...
function createObservableTypeCheckerCreator(allowNativeType, mobxType) {
  return createChainableTypeChecker(function (props, propName, componentName, location, propFullName) {
    return Object(mobx_esm["q" /* untracked */])(function () {
      ...
      switch (mobxType) {
        case "Array":
          mobxChecker = mobx_esm["j" /* isObservableArray */];
          break;

        case "Object":
          mobxChecker = mobx_esm["l" /* isObservableObject */];
          break;

        case "Map":
          mobxChecker = mobx_esm["k" /* isObservableMap */];
          break;
...
var lib_all = __webpack_require__(56);
...
var esm_useForceUpdate = __webpack_require__(37);

// EXTERNAL MODULE: ./node_modules/@restart/hooks/esm/useMergedRefs.js
var useMergedRefs = __webpack_require__(38);
...
var AbstractNav = react_default.a.forwardRef(function (_ref, ref) {
  ...
  var forceUpdate = Object(esm_useForceUpdate["a" /* default */])();
  ...
  var getNextActiveChild = function getNextActiveChild(offset) {
    ...
    var items = Object(querySelectorAll["a" /* default */])(currentListNode, '[data-rb-event-key]:not(.disabled)');
...
var TabContent = react_default.a.forwardRef(function (_ref, ref) {
  var bsPrefix = _ref.bsPrefix,
      ...
      Component = _ref$as === void 0 ? 'div' : _ref$as,
      className = _ref.className,
      props = Object(objectWithoutPropertiesLoose["a" /* default */])(_ref, ["bsPrefix", "as", "className"]);
...
var ownerDocument = __webpack_require__(8);
...
// EXTERNAL MODULE: ./src/next/clientOnly/DeliveryProblem/types.ts
var types = __webpack_require__(17);

// CONCATENATED MODULE: ./src/next/clientOnly/DeliveryProblem/images/snowplow.svg
/* harmony default export */ var images_snowplow = (__webpack_require__.p + "clientOnly/DeliveryProblem/snowplow.svg");
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/defineProperty.js
var defineProperty = __webpack_require__(7);
var defineProperty_default = /*#__PURE__*/__webpack_require__.n(defineProperty);

// CONCATENATED MODULE: ./src/next/clientOnly/DeliveryProblem/utils.ts




var radToDegrees = function radToDegrees(angle) {
...
var getAngleBetweenVectors = function getAngleBetweenVectors(pointA, pointB) {
  var deltaY = pointB.y - pointA.y;
  var deltaX = pointB.x - pointA.x;
  var angle = Math.atan2(deltaY, deltaX);
  return radToDegrees(angle + Math.PI);
};
var utils_getCanvasSize = function getCanvasSize(coords) {
  var xs = coords.map(function (coord) {
    var _coord = slicedToArray_default()(coord, 2),
        x = _coord[0],
        _ = _coord[1];

    return x;
  });
  var ys = coords.map(function (coord) {
    var _coord2 = slicedToArray_default()(coord, 2),
        _ = _coord2[0],
        y = _coord2[1];
...
var utils_normalizeCoords = function normalizeCoords(coords) {
  var xs = coords.map(function (coord) {
    var _coord3 = slicedToArray_default()(coord, 2),
        x = _coord3[0],
        _ = _coord3[1];
  ...
  var ys = coords.map(function (coord) {
    var _coord4 = slicedToArray_default()(coord, 2),
        _ = _coord4[0],
        y = _coord4[1];
  ...
  return coords.map(function (coord) {
    var _coord5 = slicedToArray_default()(coord, 2),
        x = _coord5[0],
        y = _coord5[1];
...
// CONCATENATED MODULE: ./src/next/clientOnly/DeliveryProblem/constants.ts
...
var LEVELS = LEVELS_DEFAULT.map(function (level) {
  var normalizedCoords = utils_normalizeCoords(level.points);
  return _objectSpread(_objectSpread({}, level), {}, {
    normalizedCoords: normalizedCoords,
    startingPoint: {
      x: normalizedCoords[2][0],
      y: normalizedCoords[2][1]
    }
  });
});
var GRID_SIZE = 2;
var PLOW_TRUCK_SIZE = 80;
...
// CONCATENATED MODULE: ./src/next/clientOnly/DeliveryProblem/store.ts
...
var store_Store = /*#__PURE__*/function () {
  function Store(level) {
    ...
    defineProperty_default()(this, "isSolved", false);

    defineProperty_default()(this, "isFinished", false);

    defineProperty_default()(this, "path", 0);

    defineProperty_default()(this, "traveledPoints", []);

    defineProperty_default()(this, "points", []);

    defineProperty_default()(this, "pathDelta", 0);

    defineProperty_default()(this, "level", 0);

    defineProperty_default()(this, "position", {
      x: 0,
      y: 0
    });

    defineProperty_default()(this, "isRestored", false);

    Object(mobx_esm["m" /* makeObservable */])(this, {
      isSolved: mobx_esm["n" /* observable */],
      path: mobx_esm["n" /* observable */],
      traveledPoints: mobx_esm["n" /* observable */],
      points: mobx_esm["n" /* observable */],
      pathDelta: mobx_esm["n" /* observable */],
      position: mobx_esm["n" /* observable */],
      isRestored: mobx_esm["n" /* observable */],
      updatePathLength: mobx_esm["f" /* action */],
      checkIsSolved: mobx_esm["f" /* action */],
      updateTraveledPoints: mobx_esm["f" /* action */],
      addPoint: mobx_esm["f" /* action */],
      isPointDisabled: mobx_esm["f" /* action */],
      handleSuccess: mobx_esm["f" /* action */],
      checkIsFinished: mobx_esm["f" /* action */],
      setPosition: mobx_esm["f" /* action */],
      reset: mobx_esm["f" /* action */]
    });
    this.level = level;
  ...
  createClass_default()(Store, [{
    key: "updatePathLength",
    value: function updatePathLength(pointA, pointB) {
      var path = Math.sqrt(Math.pow(pointA.x - pointB.x, 2) + Math.pow(pointA.y - pointB.y, 2));
      this.path = this.path + path;
    }
  }, {
    key: "updateTraveledPoints",
    value: function updateTraveledPoints(pointA, pointB) {
    ...
    value: function addPoint(point) {
      if (!this.points.find(function (p) {
        return p.x === point.x && point.y === point.y;
      })) {
    ...
    key: "checkIsSolved",
    value: function checkIsSolved() {
      this.isSolved = roundFloat(this.path) === roundFloat(LEVELS[this.level].answer);
    }
  }, {
    key: "isPointDisabled",
    value: function isPointDisabled(point) {
      return Boolean(this.points.find(function (p) {
        return p.x === point.x && point.y === point.y;
      }));
    }
  }, {
...
var useCallbackRef = __webpack_require__(32);

// EXTERNAL MODULE: ./node_modules/@restart/hooks/esm/useWillUnmount.js + 1 modules
var useWillUnmount = __webpack_require__(22);
...
var useMounted = __webpack_require__(33);

// EXTERNAL MODULE: ./node_modules/@restart/hooks/esm/usePrevious.js
var usePrevious = __webpack_require__(34);
...
var useWaitForDOMRef = __webpack_require__(35);
...
// CONCATENATED MODULE: ./src/next/clientOnly/DeliveryProblem/clientOnlyStore.ts
...
var clientOnlyStore_ClientOnlyStore = /*#__PURE__*/function () {
  function ClientOnlyStore() {
    classCallCheck_default()(this, ClientOnlyStore);

    defineProperty_default()(this, "progress", void 0);

    Object(mobx_esm["m" /* makeObservable */])(this, {
      progress: mobx_esm["n" /* observable */],
      setLevelComplete: mobx_esm["f" /* action */]
    });
    this.progress = {
      0: {
        isCompleted: false
  ...
  createClass_default()(ClientOnlyStore, [{
    key: "setLevelComplete",
    value: function setLevelComplete(level) {
      // @ts-ignore
      this.progress[level].isCompleted = true;
    }
  }]);

  return ClientOnlyStore;
}();
// CONCATENATED MODULE: ./src/next/clientOnly/DeliveryProblem/Game.tsx
...
var Game_moveTruckToPoint = function moveTruckToPoint(level, elem, targetPoint, prevPoint, duration) {
  var rotation = 0;

  if (prevPoint) {
    var processedPrevPoint = {
      x: utils_getCanvasSize(LEVELS[level].normalizedCoords).width - prevPoint.x - OFFSET,
      // @ts-ignore
      y: prevPoint.y + OFFSET
    };
    var processedTargetPoint = {
      x: utils_getCanvasSize(LEVELS[level].normalizedCoords).width - targetPoint.x - OFFSET,
      // @ts-ignore
  ...
  gsapWithCSS.to(elem, {
    ...
    rotation: "".concat(rotation, "_short")
  });
  gsapWithCSS.to(elem, {
    delay: 0.5,
    x: utils_getCanvasSize(LEVELS[level].normalizedCoords).width - targetPoint.x * GRID_SIZE - PLOW_TRUCK_SIZE / 3 - OFFSET,
    // @ts-ignore
...
var Point = mobxreact_esm_observer(function (_ref) {
  var x = _ref.x,
      y = _ref.y,
      handleClick = _ref.handleClick,
      isDisabled = _ref.isDisabled,
      coordinatesVisible = _ref.coordinatesVisible,
      level = _ref.level,
      realCoords = _ref.realCoords;
  return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, /*#__PURE__*/react_default.a.createElement("div", {
    className: "point ".concat(isDisabled ? 'pointDisabled' : ''),
    onClick: function onClick() {
      return handleClick();
    } // @ts-ignore
    ,
    style: {
      top: y * GRID_SIZE + OFFSET,
      left: utils_getCanvasSize(LEVELS[level].normalizedCoords).width - x * GRID_SIZE - OFFSET
    }
  }), coordinatesVisible && /*#__PURE__*/react_default.a.createElement("div", {
    className: "pointLegend" // @ts-ignore
    ,
    style: {
      top: y * GRID_SIZE + 15 + OFFSET,
      left: utils_getCanvasSize(LEVELS[level].normalizedCoords).width - x * GRID_SIZE - OFFSET
    }
  }, "(", realCoords.x, ", ", realCoords.y, ")"));
});
var Points = mobxreact_esm_observer(function (_ref2) {
  var coords = _ref2.coords,
      handlePointClick = _ref2.handlePointClick,
      children = _ref2.children,
      getIsPointDisabled = _ref2.getIsPointDisabled,
      coordinatesVisible = _ref2.coordinatesVisible,
      level = _ref2.level;
  var realCoords = LEVELS[level].points;
  return /*#__PURE__*/react_default.a.createElement("div", {
    className: "pointsContainer",
    style: {
      width: "".concat(utils_getCanvasSize(LEVELS[level].normalizedCoords).width, "px"),
      height: "".concat(utils_getCanvasSize(LEVELS[level].normalizedCoords).height, "px")
    }
  }, coords.map(function (point, index) {
    var _point = slicedToArray_default()(point, 2),
        x = _point[0],
        y = _point[1];

    var _realCoords$index = slicedToArray_default()(realCoords[index], 2),
        xR = _realCoords$index[0],
        yR = _realCoords$index[1];

    return /*#__PURE__*/react_default.a.createElement(Point, {
...
var Game_Canvas = function Canvas(_ref3) {
  ...
  var draw = function draw() {
    ...
    ctx.moveTo(utils_getCanvasSize(LEVELS[level].normalizedCoords).width - from.x * GRID_SIZE - OFFSET, from.y * GRID_SIZE + OFFSET); // @ts-ignore

    ctx.lineTo(utils_getCanvasSize(LEVELS[level].normalizedCoords).width - to.x * GRID_SIZE - OFFSET, to.y * GRID_SIZE + OFFSET);
    ctx.stroke();
  };
...
var GameView = mobxreact_esm_observer(function (_ref4) {
  var level = _ref4.level,
      store = _ref4.store,
      clientStore = _ref4.clientStore;
  var snowplow = react_default.a.useRef(null);

  var _React$useState = react_default.a.useState(false),
      _React$useState2 = slicedToArray_default()(_React$useState, 2),
      showSuccessModal = _React$useState2[0],
      setShowSuccessModal = _React$useState2[1];

  var _React$useState3 = react_default.a.useState(false),
      _React$useState4 = slicedToArray_default()(_React$useState3, 2),
      showFailureModal = _React$useState4[0],
      setShowFailureModal = _React$useState4[1];

  var _React$useState5 = react_default.a.useState(false),
      _React$useState6 = slicedToArray_default()(_React$useState5, 2),
      isCoordVisible = _React$useState6[0],
      setCoordsVisible = _React$useState6[1];

  var closeSuccessModal = function closeSuccessModal() {
    return setShowSuccessModal(false);
  };

  var closeFailureModal = function closeFailureModal() {
    return setShowFailureModal(false);
  };

  var canvasRef = react_default.a.useRef(null);
  react_default.a.useEffect(function () {
    if (store.isFinished) {
      if (store.isSolved) {
  ...
  react_default.a.useEffect(function () {
    if (level !== null) {
      Game_moveTruckToPoint(level, snowplow.current, Object(mobx_esm["p" /* toJS */])(store.position), null, 0);
    }
  ...
  return /*#__PURE__*/react_default.a.createElement("div", {
    className: "container container-".concat(level)
  }, /*#__PURE__*/react_default.a.createElement("div", {
    className: "center"
  }, /*#__PURE__*/react_default.a.createElement(Game_Canvas, {
    level: level,
    from: store.position,
    to: store.traveledPoints.length > 0 ? store.traveledPoints[store.traveledPoints.length - 1][1] : undefined,
    canvasRef: canvasRef
  }), /*#__PURE__*/react_default.a.createElement(Points, {
    coords: LEVELS[level].normalizedCoords,
    handlePointClick: function handlePointClick(_ref5) {
      var x = _ref5.x,
          y = _ref5.y;

      if (!store.isPointDisabled({
        x: x,
        y: y
      })) {
        Game_moveTruckToPoint(level, snowplow.current, {
          x: x,
          y: y
        }, store.position);
        store.updatePathLength({
          x: x,
          y: y
        }, store.position);
        store.updateTraveledPoints({
          x: x,
          y: y
        }, store.position);
        store.addPoint({
    ...
    getIsPointDisabled: function getIsPointDisabled(point) {
      return store.isPointDisabled(point);
    },
  ...
  }, isCoordVisible ? 'Hide coordinates' : 'Show coordinates'), ' ', /*#__PURE__*/react_default.a.createElement(esm_Button, {
    variant: "secondary",
    onClick: function onClick() {
      store.reset();
      Game_moveTruckToPoint(level, snowplow.current, Object(mobx_esm["p" /* toJS */])(store.position), null, 0); // clear canvas
    ...
    onCloseModal: function onCloseModal() {
      return closeFailureModal();
    },
    text: store.traveledPoints.length < LEVELS[level].points.length ? 'Your route is missing some of the points.' : "Your route is ".concat(store.pathDelta, "% longer than the optimal one. Please try again.")
  }));
});

var Game_Game = function Game(_ref6) {
...
/* harmony default export */ var DeliveryProblem_Game = (Game_Game);
...
// CONCATENATED MODULE: ./src/next/clientOnly/DeliveryProblem/App.tsx
...
var App = mobxreact_esm_observer(function (_ref) {
  ...
  }, /*#__PURE__*/react_default.a.createElement(esm_Jumbotron, null, /*#__PURE__*/react_default.a.createElement(esm_Container, null, /*#__PURE__*/react_default.a.createElement("h1", null, "Delivery Problem"), /*#__PURE__*/react_default.a.createElement("p", null, "Visit all the points (and get back to the initial location) by a shortest route."))), /*#__PURE__*/react_default.a.createElement(esm_Container, null, /*#__PURE__*/react_default.a.createElement(esm_Tabs, {
    defaultActiveKey: "level0",
    id: "uncontrolled-tab-example"
  }, arrays_range(Object.keys(store.progress || {}).length).map(function (level) {
    return /*#__PURE__*/react_default.a.createElement(esm_Tab, {
      eventKey: "level".concat(level),
      title: "Level ".concat(level + 1) // @ts-ignore
      ,
      tabClassName: store.progress[level].isCompleted ? 'levelCompleted' : ''
    }, /*#__PURE__*/react_default.a.createElement(DeliveryProblem_Game, {
      level: level,
      clientStore: store
    }));
  }))), /*#__PURE__*/react_default.a.createElement("div", {
    className: "footer"
  }, /*#__PURE__*/react_default.a.createElement(esm_Container, null, "These interactive puzzles are part of two specializations at Coursera: ", /*#__PURE__*/react_default.a.createElement("a", {
    href: "http://bit.ly/2B6a3Nn"
  }, "Introduction to Discrete Mathematics for Computer Science"), " and ", /*#__PURE__*/react_default.a.createElement("a", {
    href: "http://bit.ly/2AYsLpZ"
  }, "Data Structures and Algorithms"), ". They provide you with a fun way to \"invent\" the key ideas on your own! Even if you fail to solve some puzzles, the time will not be lost as you will better appreciate the beauty and power of the underlying ideas. Besides more than 50 such puzzles, the specializations contain more than 100 programming challenges. We encourage you to sign up for a session and learn this material while interacting with thousands of other talented students from around the world.")));
});
var App_store = new clientOnlyStore_ClientOnlyStore();
/* harmony default export */ var DeliveryProblem_App = (function () {
  return /*#__PURE__*/react_default.a.createElement(App, {
    store: App_store
  });
});
// CONCATENATED MODULE: ./src/next/clientOnly/DeliveryProblem/index.tsx





react_dom_default.a.render( /*#__PURE__*/react_default.a.createElement(DeliveryProblem_App, null), document.getElementById('root'));
